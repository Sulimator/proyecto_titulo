...
max_processed = 6000  # Detenerse después de 3000 objetos procesados
...
for i, oid in enumerate(oid_subset):
    if processed_count >= max_processed:
        print("Se ha alcanzado el límite de procesamiento de 3000 objetos. Deteniendo ejecución.")
        break
            ...
            try:
                with fits.open(fits_file) as hdul:
                    ...
                    if data is not None and cdelt1 is not None:
                        resoluciones_multires[f"{cdelt1:.6f}"] = data  # Guardar con nombre basado en resolución
